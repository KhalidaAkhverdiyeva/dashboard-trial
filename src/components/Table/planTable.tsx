        ...
        <table className="table-auto text-left border-separate border-spacing-y-0 w-full min-w-max">
          <thead>
            ...
            <tr>
              ...
              <th className="flex h-[22px] gap-[8px] justify-center items-center text-[12px] font-[500] text-center px-[6px] text-white bg-[#295197] border border-[#4069B2] whitespace-nowrap">
                SPI
              ...
              <th className="flex h-[22px] gap-[8px] justify-center items-center text-[12px] font-[500] text-center px-[6px] text-white bg-[#368AC2] border border-[#55A5DB] whitespace-nowrap">
                SPI
                <div className="flex items-center justify-center gap-[2px] ">
                  <div className="w-[10px] h-[10px] border-[1px] bg-[#C51212] rounded-full border-solid border-[#E92626]"></div>
                  <span className="text-[#E92626] text-[10px]">{">0,9"}</span>
              ...
              <th className="text-[12px] font-[500] text-center px-[6px] text-white bg-[#219886] border border-[#32B19F] whitespace-nowrap">
                <div className="flex gap-[3px] justify-center items-center">
                  Plan
                  <img
                    src="/icons/Ellipse 12.png"
              ...
              <th className="flex h-[22px] gap-[8px] justify-center items-center text-[12px] font-[500] text-center px-[6px] text-white bg-[#219886] border border-[#32B19F] whitespace-nowrap">
                SPI
                <div className="flex items-center justify-center gap-[2px] ">
                  <div className="w-[10px] h-[10px] border-[1px] bg-[#C51212] rounded-full border-solid border-[#E92626]"></div>
                  <span className="text-[#E92626] text-[10px]">{">0,9"}</span>
